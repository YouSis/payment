 ...
 *
 */
public class OPSOrderResponseDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1412351241190078505L;
	...
	public String toString() {
		...
		builder.append("OrderQueryResDTO [bpOrderId=");
		...
		builder.append(nickname);
		builder.append(", payNickname=");
		builder.append(payNickname);
		builder.append(", showUrl=");
		builder.append(showUrl);
		builder.append(", bpId=");
		builder.append(bpId);
		builder.append(", initOrderTerminal=");
		builder.append(initOrderTerminal);
		builder.append(", initOrderTerminalName=");
		builder.append(initOrderTerminalName);
	 ...
	 * 
	 */
	public OPSOrderResponseDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public OPSOrderResponseDTO(String bpOrderId, String bpName,
			String orderTradeNo, Long createDate, Long payDate, String content,
			String account, Double totalFee, String payType,
			String payTypeName, String paySerialNumber, Long status,
			String statusName, String detailUrl, String operationUrl,
			String payBank, String goodsName, String payAccount, String unid,
			String nickname, String payNickname, String showUrl, Long bpId,
			String initOrderTerminal, String initOrderTerminalName,
			String finalPayTerminal, Double channelFeeCost, String payIp,
			Integer payService, Double needPayPrice, Double bargainIncome,
			String payCurrency, String merCode) {
		super();
		this.bpOrderId = bpOrderId;
		this.bpName = bpName;
		this.orderTradeNo = orderTradeNo;
